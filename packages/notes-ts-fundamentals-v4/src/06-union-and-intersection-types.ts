...
// let evenOrLowNumber: Evens | OneThroughFive; //? already declared above
...
if (second instanceof Error) {
    // In this branch of your code, second is an Error so we have all the fields available
    second
} else {
    // In this branch of your code, second is the user info so we have all the fields available
    second
}
